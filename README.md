# 💫 About Me:
👋 **Hey there! Welcome to my GitHub!**<br><br>I'm someone who loves building things, breaking them, fixing them, and learning something new in the process. 🚀<br>Most of my time is spent experimenting with different technologies, working on personal projects, and sharpening my skills one commit at a time.<br><br>I enjoy turning ideas into real projects, exploring new tools, and solving practical problems along the way. Whether it's a small experiment or a full project, every repo here is part of my learning journey.<br><br>🛠 **What you'll find here:**<br><br>* Personal projects and experiments<br>* Things I'm currently learning<br>* Random ideas turned into code<br>* Continuous improvements and refactors<br><br>📈 I'm always looking to grow as a developer, so this space is constantly evolving.<br><br>Feel free to explore the repositories, check out what I'm building, or follow along as I keep learning and creating! ⭐<br>
...
![](https://nirzak-streak-stats.vercel.app/?user=Davepool-00&theme=dark&hide_border=false)<br/>
...
---
[![](https://visitcount.itsvg.in/api?id=Davepool-00&icon=0&color=0)](https://visitcount.itsvg.in)
...
### style
Code style changes (formatting, spaces, etc.)

```
style: format code with prettier
style: fix indentation in main file
```
...
test: improve API test coverage
```
...
```
revert: revert login feature commit
revert: undo previous API changes
```
...
wip: implementing authentication system
```
